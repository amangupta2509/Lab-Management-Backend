...
exports.validateBooking = [
  body('equipment_id')
    ...
    .isInt({ min: 1 }).withMessage('Invalid equipment ID'),
  ...
  body('purpose')
    .optional()
    .trim()
    .isLength({ max: 500 }).withMessage('Purpose too long (max 500 characters)'),
...
exports.validateEquipment = [
  ...
  body('model_number')
    .optional()
    .trim()
    .isLength({ max: 100 }).withMessage('Model number too long'),
  ...
  body('status')
    .optional()
    .isIn(['available', 'in_use', 'maintenance', 'deleted']).withMessage('Invalid status'),
...
exports.validatePrintLog = [
  body('print_count')
    .notEmpty().withMessage('Print count is required')
    .isInt({ min: 1, max: 1000 }).withMessage('Print count must be between 1 and 1000'),
...
exports.validateDateRange = [
  query('date_from')
    .optional()
    .isDate().withMessage('Invalid date format for date_from'),
  
  query('date_to')
    .optional()
    .isDate().withMessage('Invalid date format for date_to')
    .custom((dateTo, { req }) => {
